...
For more details and to download the latest version, visit the [[GitHub repository]](https://github.com/pstansfeld/cg2at). CG2AT2 does not require compilation and can be downloaded, ready to run from either Github or Zenodo, however, it is also available from pip:
