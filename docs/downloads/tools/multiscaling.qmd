...
For more details and to download the latest version, visit the [[GitHub repository]](https://github.com/pstansfeld/cg2at). CG2AT2 does not require compilation and can be downloaded, ready to run from either Github or Zenodo, however, it is also available from conda:

```sh
conda install -c stansfeld_rg cg2at
```

More extensive information and a tutorial can be found [\[here\]](../../tutorials/Martini3/cg2at/index.qmd).

When using this method, please cite:

> Vickery, O. N., & Stansfeld, P. J. (2021). CG2AT2: an enhanced fragment-based approach for serial multi-scale molecular dynamics simulations. _Journal of Chemical Theory and Computation_, _17_(10), 6472. , https://doi.org/10.1021/acs.jctc.1c00295>
:::
